...
public class AccountOverviewController {
	...
	private void initialize() {
		...
		deleteButton.disableProperty().bind(Bindings.isEmpty(transactionsTable.getSelectionModel()
						.getSelectedItems()));

		editButton.disableProperty().bind(Bindings.size(transactionsTable.getSelectionModel()
	...
	private void handleDeleteAction(ActionEvent event) {
		...
		RemoveTransactionCommand removeTransactionCommand = new RemoveTransactionCommand(transactionsToDelete, data);
