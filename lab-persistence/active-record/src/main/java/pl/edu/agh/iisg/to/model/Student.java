...
public class Student {
    ...
    public Map<Course, Float> createReport() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                float avg_course_grade = getCourseAverageGrade(course_id);
                report.put(Course.findById(course_id).get(), avg_course_grade);
            }
    ...
    private float getCourseAverageGrade(int course_id) {
